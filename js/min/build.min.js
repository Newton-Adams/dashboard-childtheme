...
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '#save-post.job-save', function (event) {
    ...
    var mechanics = [];
    $('.select-wrapper.mechanics .options > span').each(function (index, mechanic) {
...
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '.select-wrapper.mechanics .options > span', function () {
    ...
    selectedMechanics.length > 0 ? selectedMechanics += ",".concat(self.text()) : selectedMechanics = self.text();
