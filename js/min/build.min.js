...
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '.delete-row', function (e) {
    ...
    var value = form.find('.form-row:first-child .quantity-wrapper input').val();
  ...
  function updateTotalCosts(subtotal1, subtotal2) {
    var total1 = Number($(subtotal1).find('.sub-total .value').text().replace('R', ''));
    var vat1 = Number($(subtotal1).find('.vat .value').text().replace('R', ''));
    var total2 = Number($(subtotal2).find('.sub-total .value').text().replace('R', ''));
  ...
  if ($('.get-started-guide').length) {
    var businessForm = $('.add-business-form');
    var businessFormHeight = businessForm[0].scrollHeight + 'px';
