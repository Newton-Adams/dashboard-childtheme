...
jQuery(document).ready(function ($) {
  ...
  if ($('.job-select-wrapper.customer .customer-select').length > 0) {
    ...
    $(document).on('click', '.job-select-wrapper.vehicle .pre-vehicle-selection > .options > li', function () {
      ...
      var selectedVehicleData = $(this).data("vehicle-all");
  ...
  $(document).on('click', '#save-post.job-save', function (event) {
    ...
    var jobStatus = $('input#job-status').val();
...
jQuery(document).ready(function ($) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $(document).on('click', '#jobs-table tbody tr td:not(.actions)', function () {
          var jobID = $(this).closest('tr').find('.action-ellipses').data('id');
          var tr = $(this);
  ...
  function instantiateVehicleTable() {
    $.ajax({
      ...
      success: function success(response) {
        var tableData = JSON.parse(response);
        var vehicleTable = new DataTable('#vehicleTable', {
          data: tableData,
          pageLength: 7,
          columns: [{
        ...
        function countVisibleRows() {
          var rowCount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
          var tableRows = $('#vehicleTable tbody tr td').length && rowCount === undefined ? $('#vehicleTable tbody tr').length : rowCount;
...
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '.select-wrapper.job-status.active .options > span', function () {
    ...
    Array.from($('.control-status')).forEach(function (ele) {
      $(ele).text(text);
      console.log(ele);
    });
