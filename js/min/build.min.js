...
jQuery(document).ready(function ($) {
  ...
  function validateForm(form) {
    ...
    if (form) {
      ...
      var formFields = form.find('input.required, select.required, textarea.required');
      ...
      formFields.each(function () {
        ...
        if (self.attr('type') === 'tel') {
          var cellphonePattern = /^\d{10}$/; // Assuming 10 digit cellphone format
  ...
  if ($('.job-select-wrapper.customer .customer-select').length > 0) {
    var vehicleOptions = function vehicleOptions(self) {
      ...
      var vehicleOptions = "<li \n                                        data-vin=\"".concat(dataValues['vin'], "\" \n                                        data-mileage=\"").concat(dataValues['mileage'], "\" \n                                        data-make=\"").concat(dataValues['make'], "\" \n                                        data-model=\"").concat(dataValues['model'], "\" \n                                    >\n                                        <p class=\"make-model\" > ").concat(dataValues['make'], " / ").concat(dataValues['model'], " / ").concat(dataValues['colour'], " </p>\n                                        <p class=\"registration\" > ").concat(dataValues['registration'], " </p>\n                                    </li>");
  ...
  $(document).on('click', '#save-post.technicians-save', function () {
    ...
    //Labour Rows
    var mechanicsForm = document.getElementById("add-staff");
    var mechanicsFormData = new FormData(mechanicsForm);
    var mechanicRowArray = [];
    var mechanicKeyAndValue = {};
    var mechanicSortedFormData = {};
    var mechanicI = 0;
    var mechanicRowNum = 0;
    //The loop count is based on the number of fields in the form
    var _iterator = _createForOfIteratorHelper(mechanicsFormData.entries()),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (mechanicI < 3) {
          ...
          if (mechanicI === 3) {
            mechanicI = 0;
            mechanicSortedFormData["row-".concat(mechanicRowNum)] = mechanicRowArray;
            mechanicRowArray = [];
            mechanicRowNum++;
          }
        }
  ...
  $(document).on('click', '#save-post.job-save', function () {
    ...
    var partsRowNum = 0;
    //The loop count is based on the number of fields in the form
    var _iterator3 = _createForOfIteratorHelper(partsFormData.entries()),
      _step3;
    try {
  ...
  $(document).on('click', '#save-post.customer-save', function () {
    //Details Fields
    var customerDetailsFieldForm = document.getElementById("customer-fields");
    var detailsFormData = new FormData(customerDetailsFieldForm);
    var detailsArray = [];
    var detailsKeyAndValue = {};
    var detailsI = 0;
    //The loop count is based on the number of fields in the form
    var _iterator4 = _createForOfIteratorHelper(detailsFormData.entries()),
      _step4;
    try {
    ...
    var customerContactFieldForm = document.getElementById("contact-fields");
    var contactFormData = new FormData(customerContactFieldForm);
    var customerName = "";
    var contactArray = [];
    var contactKeyAndValue = {};
    var contactI = 0;
    //The loop count is based on the number of fields in the form
    var _iterator5 = _createForOfIteratorHelper(contactFormData.entries()),
      _step5;
    try {
      for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
        ...
        if (contactI < 10) {
          contactKeyAndValue = {};
          var _pairkey2 = _pair2[0];
          var _pairValue2 = _pair2[1];
          if (contactKeyAndValue[_pairkey2] === undefined) {
            contactKeyAndValue[_pairkey2] = "";
          }
          if (_pairkey2 === "first-name-1" || _pairkey2 === "last-name-1") {
            customerName += _pairValue2 + " ";
          }
          contactKeyAndValue[_pairkey2] += _pairValue2;
    ...
    var vehicleFieldForm = document.getElementById("vehicle-fields");
    var vehicleFormData = new FormData(vehicleFieldForm);
    var vehicleVin = "";
    var vehicleObject = {};
    var vehicleKeyAndValue = {};
    var vehicleI = 0;
    //The loop count is based on the number of fields in the form
    var _iterator6 = _createForOfIteratorHelper(vehicleFormData.entries()),
      _step6;
    try {
      for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
        var _pair3 = _step6.value;
        if (vehicleI < 9) {
          var _pairkey3 = _pair3[0];
          var _pairValue3 = _pair3[1];
          console.log(vehicleKeyAndValue, _pairkey3, _pairValue3);
          if (vehicleKeyAndValue[_pairkey3] === undefined) {
            vehicleKeyAndValue[_pairkey3] = "";
          }
          if (_pairkey3 === "VIN") {
            vehicleVin = _pairValue3;
          }
          vehicleKeyAndValue[_pairkey3] += _pairValue3;
  ...
  $(document).on('change', '#attachment', function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        var jobAttachments = JSON.parse($("#attachments-obj").val());
        ...
        jobAttachments.forEach(function (attachmentArray) {
  ...
  $(document).on('click', '#attachment-files .delete', function () {
    var attachment_file_url = $(this).attr('attachment_id');
    var self = $(this);
    addLoader(self);
    $.ajax({
      type: "POST",
...
(function (factory) {
  ...
  var _filterString = function _filterString(stripHtml, diacritics) {
    return function (str) {
...
(function (factory) {
  ...
  $.extend(Responsive.prototype, {
    ...
    _resizeAuto: function _resizeAuto() {
      ...
      // Header
      dt.table().header.structure(visibleColumns).forEach(function (row) {
      ...
      // Footer
      dt.table().footer.structure(visibleColumns).forEach(function (row) {
        var cells = row.filter(function (el) {
          return el ? true : false;
        }).map(function (el) {
          return $(el.cell).clone(false).css('display', 'table-cell').css('width', 'auto').css('min-width', 0);
     ...
     * @param {*} structure
     */
    _setHeaderVis: function _setHeaderVis(col, showHide, structure) {
      var that = this;
     ...
     */
    _colspan: function _colspan(row, idx) {
      var colspan = 1;
  ...
  function instantiateJobsTable() {
    $.ajax({
      ...
      success: function success(response) {
        ...
        //Create Table
        var jobsTable = new DataTable('#jobs-table', {
          data: tableData,
          pageLength: 7,
          columns: [{
            data: 'name'
        ...
        $(document).on('click', '.select-wrapper.date-range .options > span', function () {
          ...
          for (var i = 0; i < dayCount; i++) {
            ...
            var searchString = currentDate.toLocaleDateString('en-US', {
              day: '2-digit',
              month: '2-digit',
              year: 'numeric'
            });
          ...
          var columnData = jobsTable.column(1).nodes();
          for (var _i = 0; _i < columnData.length; _i++) {
            var date = $(columnData[_i]).text();
            if (!validDates.includes(date) && dayCount > 0) {
              $(columnData[_i]).closest('tr').hide();
            } else {
              $(columnData[_i]).closest('tr').show();
            }
          }

          //Count Rows
          var rows = $('#jobs-table tbody tr:not([style="display: none;"]):not(.dt-empty)');
        ...
        //Result Count
        var loadRows = $('#jobs-table tbody tr').length;
        $('#jobs-table_wrapper > .dt-layout-row:last-child').prepend("<p class=\"row-count\" >Showing <span class=\"showing\">".concat(loadRows, "</span> of <span class=\"results\" >").concat(jobsTable.rows().count(), "</span> results found</p>"));
      }
    });
  }
...
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '.parts-container .add-row-button', function (e) {
    ...
    var jobRow = "<div class=\"form-row\" >\n                            <div class=\"input-label-wrapper part-name-wrapper\" >\n                                <label for=\"part-name-".concat(rowCount, "\" >Part Name</label>\n                                <input type=\"text\" id=\"part-name-").concat(rowCount, "\" name=\"part-name-").concat(rowCount, "\" >\n                            </div>\n                            <div class=\"input-label-wrapper warranty-wrapper\" >\n                                <label for=\"warranty-").concat(rowCount, "\" >Warranty</label>\n                                <input type=\"text\" id=\"warranty-").concat(rowCount, "\" name=\"warranty-").concat(rowCount, "\" >\n                            </div>\n                            <div class=\"input-label-wrapper cost-price-wrapper\" >\n                                <label for=\"cost-price-").concat(rowCount, "\" >Cost Price</label>\n                                <input type=\"text\" id=\"cost-price-").concat(rowCount, "\" name=\"cost-price-").concat(rowCount, "\" >\n                            </div>\n                            <div class=\"input-label-wrapper markup-wrapper\" >\n                                <label for=\"markup-").concat(rowCount, "\" >Markup (%)</label>\n                                <input type=\"text\" id=\"markup-").concat(rowCount, "\" name=\"markup-").concat(rowCount, "\" >\n                            </div>\n                            <div class=\"input-label-wrapper unit-price-wrapper\" >\n                                <label for=\"unit-price-").concat(rowCount, "\" >Unit price</label>\n                                <input type=\"text\" id=\"unit-price-").concat(rowCount, "\" name=\"unit-price-").concat(rowCount, "\" >\n                            </div>\n                            <div class=\"input-label-wrapper quantity-wrapper\" >\n                                <label for=\"qty-").concat(rowCount, "\" >Qty</label>\n                                <input type=\"text\" id=\"qty-").concat(rowCount, "\" name=\"qty-").concat(rowCount, "\" >\n                            </div>\n                            <div class=\"input-label-wrapper vat-wrapper\" >\n                                <label for=\"vat-").concat(rowCount, "\" >Vat</label>\n                                <input type=\"text\" id=\"vat-").concat(rowCount, "\" name=\"vat-").concat(rowCount, "\" >\n                            </div>\n                            <div class=\"input-label-wrapper line-total-wrapper\" >\n                                <label for=\"line-total-").concat(rowCount, "\" >Line Total</label>\n                                <input type=\"text\" id=\"line-total-").concat(rowCount, "\" name=\"line-total-").concat(rowCount, "\" >\n                            </div>\n                            <div class=\"input-label-wrapper delete-row\" >\n                                <svg width=\"14\" height=\"17\" viewBox=\"0 0 14 17\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n                                <path d=\"M4.30769 6.36667C4.60508 6.36667 4.84615 6.60545 4.84615 6.9V13.3C4.84615 13.5946 4.60508 13.8333 4.30769 13.8333C4.01031 13.8333 3.76923 13.5946 3.76923 13.3V6.9C3.76923 6.60545 4.01031 6.36667 4.30769 6.36667Z\" fill=\"#7A7A9D\"/>\n                                <path d=\"M7 6.36667C7.29738 6.36667 7.53846 6.60545 7.53846 6.9V13.3C7.53846 13.5946 7.29738 13.8333 7 13.8333C6.70262 13.8333 6.46154 13.5946 6.46154 13.3V6.9C6.46154 6.60545 6.70262 6.36667 7 6.36667Z\" fill=\"#7A7A9D\"/>\n                                <path d=\"M10.2308 6.9C10.2308 6.60545 9.98969 6.36667 9.69231 6.36667C9.39492 6.36667 9.15385 6.60545 9.15385 6.9V13.3C9.15385 13.5946 9.39492 13.8333 9.69231 13.8333C9.98969 13.8333 10.2308 13.5946 10.2308 13.3V6.9Z\" fill=\"#7A7A9D\"/>\n                                <path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M14 3.7C14 4.2891 13.5178 4.76667 12.9231 4.76667H12.3846V14.3667C12.3846 15.5449 11.4203 16.5 10.2308 16.5H3.76923C2.57969 16.5 1.61538 15.5449 1.61538 14.3667V4.76667H1.07692C0.482155 4.76667 0 4.2891 0 3.7V2.63333C0 2.04423 0.482155 1.56667 1.07692 1.56667H4.84615C4.84615 0.977563 5.32831 0.5 5.92308 0.5H8.07692C8.67169 0.5 9.15385 0.977563 9.15385 1.56667H12.9231C13.5178 1.56667 14 2.04423 14 2.63333V3.7ZM2.81942 4.76667L2.69231 4.82962V14.3667C2.69231 14.9558 3.17446 15.4333 3.76923 15.4333H10.2308C10.8255 15.4333 11.3077 14.9558 11.3077 14.3667V4.82962L11.1806 4.76667H2.81942ZM1.07692 3.7V2.63333H12.9231V3.7H1.07692Z\" fill=\"#7A7A9D\"/>\n                                </svg>\n                            </div>\n                        </div>");
  ...
  function calculateLineTotal() {
    ...
    $(this).closest('.section').find('.sub-total-outer .sub-total .value').text("R".concat(lineSubtotal.toFixed(2)));
    $(this).closest('.section').find('.sub-total-outer .vat .value').text("R".concat(vatSubtotal.toFixed(2)));
    $(this).closest('.section').find('.sub-total-outer .total .value').text("R".concat((lineSubtotal + vatSubtotal).toFixed(2)));
    updateTotalCosts('.section.jobs-container', '.section.parts-container');
  }
  ...
  $(document).on('change', '#csvFile', function (e) {
    ...
    reader.onload = function (e) {
      ...
      table += "<tr><td colspan=\"2\" >And ".concat(data.length, " more rows... </td></tr></table>");
      $('#csvData .csv-table').html(table);

      //Create progress bar
      var progresSegments = [];
      for (var _i = 0; _i < rows.length / 20; _i++) {
