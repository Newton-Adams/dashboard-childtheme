  ...
  $(document).on('click', '.edit-vehicle-action', function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        var customerData = '{"customer-name":"' + vehicleData['customer-name'] + '","company-name":"' + vehicleData['company-name'] + '","email":"' + vehicleData['calvinjdavey@gmail.com'] + '","phone":' + vehicleData['1231231234'] + ',"address":"' + vehicleData['address'] + '"}';
