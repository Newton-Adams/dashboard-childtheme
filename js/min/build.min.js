    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        function countVisibleRows() {
          ...
          $('#jobs-table_wrapper > .dt-layout-row:last-child').text("".concat(tableRows, " of ").concat(jobsTable.rows().count(), " results"));
        }

        //Result Count
        var loadRows = $('#jobs-table tbody tr').length;
        $('#jobs-table_wrapper > .dt-layout-row:last-child').prepend("<p class=\"row-count\" >Showing ".concat(loadRows, " of ").concat(jobsTable.rows().count(), " results found</p>"));
        countVisibleRows();
      }
    });
  }
