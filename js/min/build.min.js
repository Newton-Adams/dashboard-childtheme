...
jQuery(document).ready(function ($) {
  ...
  function calculateLineTotal() {
    ...
    $(this).closest('.forms-container').find('.sub-total-outer .sub-total .value').text("R".concat(lineSubtotal.toFixed(2)));
    $(this).closest('.forms-container').find('.sub-total-outer .vat .value').text("R".concat(vatSubtotal.toFixed(2)));
    $(this).closest('.forms-container').find('.sub-total-outer .total .value').text("R".concat((lineSubtotal + vatSubtotal).toFixed(2)));
  }
