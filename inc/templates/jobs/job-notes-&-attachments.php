<?php 
//  !empty(get_post_meta(579, 'attachments', true) ) && $attachments = get_post_meta(579, 'attachments', true); 
...
<table id="attachment-files" >
    ...
    if( isset($attchments_decoded) ) {
        foreach ($attchments_decoded as $key => $attachment) {
            echo '<td><a href="'.$attachment[2].'" target="_blank" >'.$attachment[0].'</a></td>';
            echo '<td class="delete" attachment_id="'.$attachment[1].'" >
