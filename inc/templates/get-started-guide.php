        ...
        <div id="add-business-form">
            ...
            <form class="form">
                ...
                <div class="form-row" >
                    ...
                    <div class="input-label-wrapper" >
                        <label for="companyregistration" >Company registration number (Optional)</label>
                        <input type="text" id="companyregistration" name="companyregistration" >
                    </div>
                </div>
            </form>
        </div>
