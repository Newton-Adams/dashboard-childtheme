...
<form id="customer-fields" >
    <div class="form-row d-flex flex-wrap" >
        ...
        <div class="fw-50 input-label-wrapper" >
            ...
            <input type="text" id="preferred-terms" name="preferred-terms" >
        </div>
        
        <div class="fw-50 input-label-wrapper" >
            <label for="physical-address" >Physical address</label>
            <input type="text" id="physical-address" name="physical-address" >
        </div>
        ...
        <div class="fw-50 input-label-wrapper" >
            ...
            <input type="text" id="vat-number" name="vat-number" >
        </div>
        
        <div class="fw-50 input-label-wrapper" >
            <label for="company-registration" >Company registration number (Optional)</label>
            <input type="text" id="company-registration" name="company-registration" >
        </div>    
    </div>
</form>